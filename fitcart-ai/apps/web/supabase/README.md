...
6. **Deploy the Edge Functions:**
   ...
   ```
   (`populate-catalog` is optional — see 7e below — but deploying it costs nothing if you don't call it.)
